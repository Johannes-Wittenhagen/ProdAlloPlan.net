...
while Test < 1:
    ...
    if i == 0:
        ...
        demand.loc[(1,'USA','K6067000'),'Nachfrage'] = Nachfrage
        demand.loc[(2,'USA','K6067000'),'Nachfrage'] = round(Nachfrage*(1+Steigerung*Durchgang/100*1.06))
        demand.loc[(3,'USA','K6067000'),'Nachfrage'] = round(Nachfrage*(1+Steigerung*Durchgang/100*1.06*1.06))
        demand.loc[(4,'USA','K6067000'),'Nachfrage'] = round(Nachfrage*(1+Steigerung*Durchgang/100*1.06*1.06*1.06))
...
while t< maximum:
    print(links,rechts)
    if suche(links) ==0 and suche(rechts) ==1:
        links = (links+rechts)/2 
    elif suche(links) ==1 and suche(rechts) ==0:
